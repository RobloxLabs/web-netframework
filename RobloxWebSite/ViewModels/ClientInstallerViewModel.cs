...
{
    public class ClientInstallerViewModel
    {
        public RobloxResourceSet VisitGameResources;
        public RobloxResourceSet ControlsResources;
        ...
        public ClientInstallerViewModel(string userAgent)
        {
        ...
        private void ConfigureClientSettings()
        {
            ...
            if (IsSupportedPlatform)
            {
                if (Browser != null)
                {
                    CLSID = GlobalProperties.CLSID32Bit;
